...
const Home = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <header className="flex items-center justify-center gap-2 p-4 text-center">
        <h1 className="text-5xl">DogiApp</h1>
        <img
          className="w-12"
      ...
      <section className="flex-col">
        ...
        {displayFav ? (
          <div className="fixed  m-auto top-0 right-0 z-10">
            <button
          ...
          <div className="relative lg:fixed top-0 right-0">
            <button
              onClick={displayFavorites}
              class=" w-36 p-3 text-xl rounded border-4 border-green-600 hover:bg-green-300 active:bg-transparent focus:outline-none focus:ring focus:ring-greeb-300 ..."
            >
              Favoritos
            </button>
          </div>
        ...
        {error ? (
          ...
          <div style={{ columnCount: 3, columnWidth: 250 }} className="py-6">
            {dogs.map((dog, idx) => (
