...
export default function Navbar() {
  ...
  const { displayFavorites, displayFav } =
    useContext(ContextBreed);
  return (
    <>
      <nav className='relative top-0 left-auto z-10 flex flex-col items-center justify-between p-3 gap-2'>
        <img
          className="w-12"
        ...
        <div className=' w-full flex gap-2' >
          ...
          <div className=" grid place-content-center place-items-center p-2">
            <button
              ...
              class="w-full rounded-xl border border-red-300 text-red p-3 text-2xl hover:bg-red-300"
            >
